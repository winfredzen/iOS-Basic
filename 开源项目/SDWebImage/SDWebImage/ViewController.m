...
-(void)download
{
    [self.imageView sd_setImageWithURL:[NSURL URLWithString:@"https://raw.githubusercontent.com/rs/SDWebImage/master/Docs/SDWebImageClassDiagram.png"] placeholderImage:[UIImage imageNamed:@"Snip20160221_306"] options: SDWebImageProgressiveDownload progress:^(NSInteger receivedSize, NSInteger expectedSize) {
...
-(void)type
{
    NSData *imageData = [NSData dataWithContentsOfFile:@"/Users/Miller/Documents/Wangzhen/iOS/code/iOS-Basic/开源项目/SDWebImage/SDWebImage/Snip20160221_292.png"];
